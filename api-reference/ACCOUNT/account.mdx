  ...
  ```json
{
    ...
    "accountType": "ORG_B2B",
    "closingDate": "2022-12-11T12:10:11+02:00" // if  "accountStatus": "SUSPENDED", instead of "closingDate" field, "suspensionReason" field could be provided. e.g. "suspensionReason":"Security breach investigation in progress."
}
  ```
</ResponseField>
</Expandable>
