...
This section provides information how to submit customer details to our database and is focused on individuals requiring risk assessment.
...
<Expandable title="Mandatory fields example | CUSTOMER import - individual with risk assessment">
<ResponseField>
  ```json
{
...
<Expandable title="Mandatory fields example | CUSTOMER import - individual with risk assessment with screening">
<ResponseField>
  ```json
{
    "communicationNumber" : "Test_ComNr_002mHzZZ",
...
<Expandable title="All fields example | CUSTOMER import - individual with risk assessment">
<ResponseField>
  ```json
{
    ...
    "incomeSourceDescription" : "Job Salary",
    "initialDepositSource": "Salary",
    "initialDepositBank" : "ABC",
...
"listContact": [
        {
            ...
            "contactDetails": "860123123",
            "useForCommunication": true
        },
        {
            "contactType": "EMAIL",
            "contactDetails": "personal@gmail.com",
            "useForCommunication": true
        }
    ],
"listAddress": [
        {
            "addressDetails": "Pilies g. 19",
            "addressType": "RESIDENCE",
            "city": "Vilnius",
            "country": "LT",
            "region": "EU",
            "streetAddress": "Pilies g.",
...
"listAppealReason": [
        {
            "appealReasonType": "PURPOSE_GET_LOAN,PURPOSE_MAKE_PAYMENTS,PURPOSE_OTHER"
        }
    ],
...
"listDeclaredTurnover": [
        {
            ...
            "turnoverType": "OPERATION_AMOUNT_MONTHLY"
        }
    ],
"listIncomeSource": [
        {
...
"listCountryOfTaxPayment": [
        {
            "country": "LT",
            "taxpayerNumber": "23846"
        }
    ],
"listAdditionalValues": [
        {
            "code": "relation_us",
            "description": "Has a relation to USA.",
            "datatype": "STRING",
            "value" : "true"
        }
    ],
...
_Example:_ `Amlyze` _(name of your system)_
</ResponseField>
...
<ResponseField name="listAdditionalValues" type="list[]">
