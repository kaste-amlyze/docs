...
This section provides information how to submit customer details to our database and is focused on individuals who doesn't require risk assessment (data migration cases).
...
<Expandable title="Mandatory fields example | CUSTOMER import - individual no risk assessment with screening">
<ResponseField>
  ```json
{
    "communicationNumber" : "Test_ComNr_002mHzZZ",
