---
title: 'Customer import - Organization with risk assessment'
icon: 'arrow-right'
---

This section provides information how to submit customer details to our database and is focused on organizations requiring risk assessment.
...
<Expandable title="Mandatory fields example | CUSTOMER import - organization with risk assessment">
<ResponseField>
  ```json
{
...
<Expandable title="Mandatory fields example | CUSTOMER import - organization with risk assessment and screening">
<ResponseField>
  ```json
{
   "communicationNumber": "Test_ComNr_003ZZZc",
...
<Expandable title="All fields example | CUSTOMER import - organization with risk assessment">
<ResponseField>
  ```json
{
...
List for related business entities. Fields of the list are described in the dropdown below.
    ...
    <Expandable title="listRelatedEntity list[] fields">
        ...
        <ResponseField name="birthCountry" type="string from classifier list">
            Birth country of the related entity. This field applies when when `entityType` is `INDIVIDUAL`.
        ...
        <ResponseField name="registrationCountry" type="string from classifier list">
            Registration country of the related entity. This field applies when when `entityType` is `ORGANIZATION`.
        ...
        **Path:** `{{baseUrl}}`/classifier/legalForm
        ...
        <ResponseField name="establishmentDate" type="date">
            Establishment date of the related organization entity.
