...
Below are examples of API requests for SEPA operation import without transaction monitoring initiation with only mandatory fields and all fields in JSON format, as well as a list of all available fields. 
