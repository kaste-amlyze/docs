...
<Note>
Just so you know, further examples and descriptions apply only to SWIFT operation imports with transaction monitoring.
</Note>
...
<Expandable title="Mandatory fields example | SWIFT operation import - with transaction monitoring">
<ResponseField>
  ```json
{
...
<Expandable title="Mandatory fields example | SWIFT operation import - with transaction monitoring with screening">
<ResponseField>
  ```json
{
    "communicationNumber": "Test_ComNr_SWIFT_05",
...
<Expandable title="All fields example | SWIFT operation import - with transaction monitoring">
<ResponseField>
  ```json
{
