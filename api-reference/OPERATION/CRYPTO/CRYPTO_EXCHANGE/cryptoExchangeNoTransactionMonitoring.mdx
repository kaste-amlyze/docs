...
<Note>
Just so you know, further examples and descriptions apply only to CRYPTO EXCHANGE operation imports without transaction monitoring.
</Note>
...
<Expandable title="Mandatory fields example | CRYPTO EXCHANGE operation import - no transaction monitoring">
<ResponseField>
  ```json
{
    ...
    "currency": "EUR",
    "amount": 760,
    "description": "invoice 'LT523461'",
    "listOperationParty": [
        {
            "partyRole": "DEBTOR",
            "accountNumber": "ORG20240919T104201",
            "bic": "BICXX22",
...
<Expandable title="Mandatory fields example | CRYPTO EXCHANGE operation import - no transaction monitoring with screening">
<ResponseField>
  ```json
{
    "communicationNumber": "Com_458",
...
<Expandable title="All fields example | CRYPTO EXCHANGE operation import - no transaction monitoring">
<ResponseField>
  ```json
{
