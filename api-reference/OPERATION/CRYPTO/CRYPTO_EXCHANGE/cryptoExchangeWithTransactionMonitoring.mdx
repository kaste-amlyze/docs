...
<Note>
Just so you know, further examples and descriptions apply only to CRYPTO EXCHANGE operation imports with transaction monitoring.
</Note>
...
<Expandable title="Mandatory fields example | CRYPTO EXCHANGE operation import - with transaction monitoring">
<ResponseField>
  ```json
{
...
<Expandable title="Mandatory fields example | CRYPTO EXCHANGE operation import - with transaction monitoring and screening">
<ResponseField>
  ```json
{
    "communicationNumber": "Com_458",
...
<Expandable title="All fields example | CRYPTO EXCHANGE operation import - with transaction monitoring">
<ResponseField>
  ```json
{
