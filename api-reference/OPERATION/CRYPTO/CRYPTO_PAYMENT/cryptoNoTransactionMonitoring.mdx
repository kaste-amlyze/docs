...
<Note>
Just so you know, further examples and descriptions apply only to CRYPT operation imports without transaction monitoring.
</Note>
...
<Expandable title="Mandatory fields example | CRYPTO operation import - no transaction monitoring">
<ResponseField>
  ```json
{
    "communicationNumber": "Com_147",
    "requester": "financial_institution",
    "operationExtId": "OpExt_145",
...
<Expandable title="Mandatory fields example | CRYPTO operation import - no transaction monitoring with screening">
<ResponseField>
  ```json
{
    "communicationNumber": "Com_147",
...
<Expandable title="All fields example | CRYPTO operation import - no transaction monitoring">
<ResponseField>
  ```json
{
