...
<Note>
Just so you know, further examples and descriptions apply only to CRYPTO operation imports with transaction monitoring.
</Note>
...
<Expandable title="Mandatory fields example | CRYPTO operation import - with transaction monitoring">
<ResponseField>
  ```json
{
...
<Expandable title="Mandatory fields example | CRYPTO operation import - with transaction monitoring and screening">
<ResponseField>
  ```json
{
{
...
<Expandable title="All fields example | CRYPTO operation import - with transaction monitoring">
<ResponseField>
  ```json
{
{
