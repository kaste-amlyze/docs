---
title: 'INTERNAL operation import - with transaction monitoring'
icon: 'arrow-right'
---
...
<Note>
Just so you know, further examples and descriptions apply only to CASH TRANSFER OUTGOING operation imports with transaction monitoring.
</Note>
...
CASH TRANSFER OUTGOING operation is a transfer of funds by cash payment.
...
<Expandable title="Mandatory fields example | CASH TRANSFER OUTGOING operation import - with transaction monitoring">
<ResponseField>
  ```json
{
    ...
    "amount": 998,
    "currency": "EUR",
    "description": "Transfer of funds by cash payment",
    "listOperationParty": [
        {
            "partyRole": "DEBTOR",
            "accountNumber": "IND20231113T18099asa",
            "bic": "BICXX33",
...
<Expandable title="Mandatory fields example | CASH TRANSFER OUTGOING operation import - with transaction monitoring and screening">
<ResponseField>
  ```json
{
    "communicationNumber": "ComNr_0011",
...
<Expandable title="All fields example | CASH TRANSFER OUTGOING operation import - with transaction monitoring">
<ResponseField>
  ```json
{
    "communicationNumber": "ComNr_0011",
...
_Example:_ `Op_01_CASH_TRANSFER_TEST`
</ResponseField>
...
_Example:_ `Transfer of funds by cash payment.`
</ResponseField>
