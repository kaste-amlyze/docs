...
<Note>
Just so you know, further examples and descriptions apply only to INTERNAL operation imports with transaction monitoring.
</Note>
...
<Expandable title="Mandatory fields example | INTERNAL operation import - with transaction monitoring">
<ResponseField>
  ```json
{
    "communicationNumber": "Test_ComNr_INTERNAL_05",
    "requester": "Company Name Amlyze",

    "operationExtId": "Op_05_INTERNAL_TEST",
    ...
    "listOperationParty": [
        ...
        {
          "partyRole": "CREDITOR",
          "accountNumber": "LT9208800274335945500",
          "bic": "AmlyzeXX22",
          "entityType": "INDIVIDUAL",
          "firstName" : "Tomas",
	        "lastName" : "Garcia"
...
<Expandable title="Mandatory fields example | INTERNAL operation import - with transaction monitoring and screening">
<ResponseField>
  ```json
{
    "communicationNumber": "Test_ComNr_INTERNAL_05",
...
<Expandable title="All fields example | INTERNAL operation import - with transaction monitoring">
<ResponseField>
  ```json
{
...
_Example:_ `Op_01_INTERNAL_TEST`
</ResponseField>
...
**Enum class values:** `DEBTOR`,  `CREDITOR`
