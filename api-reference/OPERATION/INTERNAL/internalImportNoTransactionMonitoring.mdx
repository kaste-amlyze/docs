...
<Note>
Just so you know, further examples and descriptions apply only to INTERNAL operation imports without transaction monitoring.
</Note>
...
<Expandable title="Mandatory fields example | INTERNAL operation import - no transaction monitoring">
<ResponseField>
  ```json
{
...
<Expandable title="Mandatory fields example | INTERNAL operation import - no transaction monitoring with screening">
<ResponseField>
  ```json
{
    "communicationNumber": "Test_ComNr_INTERNAL_05",
...
<Expandable title="All fields example | INTERNAL operation import - no transaction monitoring">
<ResponseField>
  ```json
{
