...
<Note>
Just so you know, further examples and descriptions apply only to CASH DEPOSIT OUTGOING operation imports without transaction monitoring.
</Note>
...
<Expandable title="Mandatory fields example | CASH DEPOSIT OUTGOING operation import - no transaction monitoring">
<ResponseField>
  ```json
{
...
<Expandable title="Mandatory fields example | CASH DEPOSIT OUTGOING operation import - no transaction monitoring and screening">
<ResponseField>
  ```json
{
    "communicationNumber": "ComNr_0011",
...
<Expandable title="All fields example | CASH DEPOSIT OUTGOING operation import - no transaction monitoring">
<ResponseField>
  ```json
{
    "communicationNumber": "ComNr_0011",
