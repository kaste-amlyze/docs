...
<Note>
Just so you know, further examples and descriptions apply only to CASH DEPOSIT OUTGOING operation imports with transaction monitoring.
</Note>
...
CASH DEPOSIT OUTGOING operation is a simple money withdrawal from the account (not a card cash withdrawal). So in this case note that:
...
<Expandable title="Mandatory fields example | CASH DEPOSIT OUTGOING operation import - with transaction monitoring">
<ResponseField>
  ```json
{
...
<Expandable title="Mandatory fields example | CASH DEPOSIT OUTGOING operation import - with transaction monitoring and screening">
<ResponseField>
  ```json
{
    "communicationNumber": "ComNr_0011",
...
<Expandable title="All fields example | CASH DEPOSIT OUTGOING operation import - with transaction monitoring">
<ResponseField>
  ```json
{
    "communicationNumber": "ComNr_0011",
