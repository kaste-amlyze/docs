...
<Note>
Just so you know, further examples and descriptions apply only to CASH DEPOSIT INCOMING operation imports without transaction monitoring.
</Note>
...
<Expandable title="Mandatory fields example | CASH DEPOSIT INCOMING operation import - no transaction monitoring">
<ResponseField>
  ```json
...
<Expandable title="Mandatory fields example | CASH DEPOSIT INCOMING operation import - no transaction monitoring with screening">
<ResponseField>
  ```json
...
<Expandable title="All fields example | CASH DEPOSIT INCOMING operation import - no transaction monitoring">
<ResponseField>
  ```json
