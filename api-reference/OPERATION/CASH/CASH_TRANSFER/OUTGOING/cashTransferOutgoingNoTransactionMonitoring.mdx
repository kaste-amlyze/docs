...
<Expandable title="Mandatory fields example | CASH TRANSFER OUTGOING operation import - no transaction monitoring">
<ResponseField>
  ```json
{
...
<Expandable title="Mandatory fields example | CASH TRANSFER OUTGOING operation import - no transaction monitoring with screening">
<ResponseField>
  ```json
{
    "communicationNumber": "ComNr_0011",
...
<Expandable title="All fields example | CASH TRANSFER OUTGOING operation import - no transaction monitoring">
<ResponseField>
  ```json
{
    "communicationNumber": "ComNr_0011",
