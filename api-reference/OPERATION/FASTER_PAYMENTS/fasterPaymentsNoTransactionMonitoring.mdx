...
<Note>
Just so you know, further examples and descriptions apply only to FASTER PAYMENT operation imports without transaction monitoring.
</Note>
...
<Expandable title="Mandatory fields example | FASTER PAYMENT operation import - no transaction monitoring">
<ResponseField>
  ```json
{
...
<Expandable title="Mandatory fields example | FASTER PAYMENT operation import - no transaction monitoring with screening">
<ResponseField>
  ```json
{
        "communicationNumber": "ComNr_0045",
...
<Expandable title="All fields example | FASTER PAYMENT operation import - no transaction monitoring">
<ResponseField>
  ```json
{
    "communicationNumber": "ComNr_0034",
    "requester": "financial_institution",
    "businessUnit": "Unit A",
    "operationExtId": "Op_0034",
    "operationType": "FASTER_PAYMENTS",
    "riskManagementCategory": "OP_DEFAULT",
    "initializeScreeningProcesses": [
        "SANCTIONS",
...
_Example:_ `Op_01_CRYPTO_EXCHANGE_TEST`
</ResponseField>
