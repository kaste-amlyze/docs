...
<Note>
Just so you know, further examples and descriptions apply only to FASTER PAYMENTS operation imports with transaction monitoring.
</Note>
...
<Expandable title="Mandatory fields example | FASTER PAYMENTS operation import - with transaction monitoring">
<ResponseField>
  ```json
{
    "communicationNumber": "ComNr_0045",
    "requester": "financial_institution",
    "operationExtId": "Op_00175",
    "operationType": "FASTER_PAYMENTS",
    ...
    "listOperationParty": [
         {
            "partyRole": "DEBTOR",
            "accountNumber": "LV5630800200000018112",
            "bic": "BICXX22",
...
<Expandable title="Mandatory fields example | FASTER PAYMENTS operation import - with transaction monitoring and screening">
<ResponseField>
  ```json
{
    "communicationNumber": "ComNr_0045",
...
<Expandable title="All fields example | FASTER PAYMENTS operation import - with transaction monitoring">
<ResponseField>
  ```json
{
    "communicationNumber": "ComNr_0033",
    "requester": "financial_institution",
    "operationExtId": "Op_0033",
    "operationType": "FASTER_PAYMENTS",
    "riskManagementCategory": "OP_DEFAULT",
    "initializeScreeningProcesses": [
        "SANCTIONS",
...
Enum class values: `INCOMING`,  `OUTGOING`, `NULL`
