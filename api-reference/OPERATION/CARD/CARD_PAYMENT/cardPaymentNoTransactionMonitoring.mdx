---
title: 'CARD-PAYMENT operation import - no transaction monitoring'
icon: 'arrow-right'
---
...
<Expandable title="Mandatory fields example | CARD-PAYMENT operation import - no transaction monitoring">
<ResponseField>
  ```json
{
...
<Expandable title="Mandatory fields example | CARD-PAYMENT operation import - no transaction monitoring with screening">
<ResponseField>
  ```json
{
    "communicationNumber": "Com_1455",
...
<Expandable title="All fields example | CARD-PAYMENT operation import - no transaction monitoring">
<ResponseField>
  ```json
{
