...
Below are examples of API requests with only mandatory fields and all fields in JSON format and a list of all available fields.
...
<Expandable title="Mandatory fields example">
<ResponseField>
  ```json
  {
...
<Expandable title="All fields example">
<ResponseField>
  ```json
  {
    "x": "https://x.com/mintlify",
...
Example: `Amlyze` (name of the company)
</ResponseField>

<ResponseField name="sourceOfRiskLevel" type="ENUM" required>
Unique number of communication. This field can store up to 256 characters.
